...
<div class="contenedor-secundario">
    ...
    <div class="plato">
      <div class="conflei"> <!-- Sección 1-->
        <img src="img/paisaje-lienzo.jpg" alt="guernica" class="imagenes-seccion-prueba">
      </div>

      <div class="leche">
        <h2 class="nombre-articulo">El Mirar</h2>
        <h2 class="Autor-articulo"> <strong>Publicado por:</strong> Euclides</h2>
        <h2 class="precio">18$</h2>
        <p class="descripcion-articulo">
            Vendo este bello cuadro titulado "El Mirar", data de 1950, está en perfecto estado.
        </p>
